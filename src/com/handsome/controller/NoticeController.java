...
import com.handsome.util.common.HrmConstants;
...
public class NoticeController {
	...
	public ModelAndView updateNotice(String flag, Notice notice, @ModelAttribute ModelAndView mv, HttpSession session) {
		if (flag.equals("1")) {
