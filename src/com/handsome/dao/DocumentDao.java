...
import com.handsome.dao.provider.DocumentDynaSqlProvider;
import com.handsome.domain.Document;
import static com.handsome.util.common.HrmConstants.DOCUMENTTABLE;
...
public interface DocumentDao {
	...
	@Results({
		...
		@Result(column="USER_ID",property="user",
			one=@One(select="com.handsome.dao.UserDao.selectById",
