...
import com.handsome.dao.provider.EmployeeDynaSqlProvider;
import com.handsome.domain.Employee;
import static com.handsome.util.common.HrmConstants.EMPLOYEETABLE;
...
public interface EmployeeDao {
	...
	@Results({
		...
		@Result(column="DEPT_ID",property="dept",
			one=@One(select="com.handsome.dao.DeptDao.selectById",
		fetchType=FetchType.EAGER)),
		@Result(column="JOB_ID",property="job",
			one=@One(select="com.handsome.dao.JobDao.selectById",
		fetchType=FetchType.EAGER))
	})
